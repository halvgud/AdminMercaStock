    ...
    <div id="wrapper">
        ...
        <script>
            ...
            class SucursalTiempo {
                static Estadistica() {
                    Funcion.peticionAjax({
                        Url:API_SYS_PATH + "sucursal/seleccionar",
                        datos:{
                            idGenerico:true
                ...
                static obtenerDetalle(idSucursal) {
                    ...
                    Funcion.peticionAjax({
                        Url:API_SYS_PATH + "general/dashboard/tiempo",
                        datos:{
            ...
            class SucursalEstadistica {
                static Estadistica() {
                    Funcion.peticionAjax({
                        Url:API_SYS_PATH + "general/dashboard",
                        /**
                        ...
                        success:function(result) {
                            ...
                            if (result.data.length <= 0) {
                                ...
                                result.data.forEach(function (element) {
                                    ...
                                    var divProgressInfo = $("<div></div>", {
                                        'class': 'progress-bar progress-bar-' + color,
                                        role: "progressbar",
                                        'aria-valuenow': element['inventarioActual'],
                                        'aria-valuemin': 0,
                                        'aria-valuemax': element['inventarioTotal'],
                                        style: "width: " +
                                        element['porcentaje'] + "%"
                                    });
                        ...
                        mensajeDeEspera: "Cargando dashboard..."
                    });
                }
            }//class
        </script>
