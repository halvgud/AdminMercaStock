            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php  } if (PrivilegiosUsuario::tienePrivilegio($decoded,"PROVEEDOR")) {  ?>
                            <li>
                                <a href="#" onclick="cambiarUrl('/catalogo/proveedor.php');"><i class="fa fa-tasks fa-fw"></i> Proveedores</a>
                            </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php if (PrivilegiosUsuario::tienePrivilegio($decoded,"GENERAR_INVENTARIO")) {  ?>
                            ...
                            <li>
                                <a href="#" onclick="cambiarUrl('/proceso/ajustar_inventario.php',true,true);"><i class="fa fa-file-text-o fa-fw"></i> Ajustar Inventario</a>
                            </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php } /*if (PrivilegiosUsuario::tienePrivilegio($decoded,"EXISTENCIAS")) {  ?>
                            ...
                            <?php }*/ if (PrivilegiosUsuario::tienePrivilegio($decoded,"INVENTARIO_SUCURSAL_ARTICULOS")) { /*INVENTARIO_SUCURSAL_ARTICULOS*/ ?>
                            <li>
