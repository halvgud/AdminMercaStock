...
<?php /*} if ($u->tienePrivilegio("nuevoMedicamento")) { */?>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="control-agendar-consulta.php"><i class="fa fa-calendar-plus-o fa-fw"></i>Consultar menus anteriores</a>
                                </li>
                                <li>
                                    <a href="control-agendar-visita.php"><i class="fa fa-calendar-plus-o fa-fw"></i>Crear menú del día</a>
                                </li>
                                <li>
                                    <a href="pase-salida.php"><i class="fa fa-file-text-o fa-fw"></i>Control del día</a>
                                </li>
                                <!--<li>
