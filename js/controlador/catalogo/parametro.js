...
function inicializarTabla3() {
    var datosTabla3 = {};
    datosTabla3['idSucursal'] = $('#idSucursal').val();
...
function editarParametros(element, tr) {
    ...
    var comentario = $("<textarea></textarea>", {
        name: 'comentario',
        value: element['comentario'],
        class: 'form-control',
        required: 'required',
        text: element['comentario']
    });
    $form_group.append(label);
    ...
    var fechaActualizacion = $("<input>", {
        name: 'fechaActualizacion',
        value: element['fechaActualizacion'],
        type: 'text',
        class: 'form-control',
        required: 'required',
        readonly: 'readonly'
